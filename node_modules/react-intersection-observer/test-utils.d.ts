 ...
 */
export declare function mockAllIsIntersecting(isIntersecting: boolean): void;
/**
 * Set the `isIntersecting` for the IntersectionObserver of a specific element.
 * @param element {Element}
 * @param isIntersecting {boolean}
 */
export declare function mockIsIntersecting(element: Element, isIntersecting: boolean): void;
/**
